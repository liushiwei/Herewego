...
package com.hhsir.herewego.logic.sgf;

import com.hhsir.herewego.logic.Cell;
import com.hhsir.herewego.logic.GoDefinitions;
import com.hhsir.herewego.logic.GoGame;
import com.hhsir.herewego.logic.GoGameMetadata;
import com.hhsir.herewego.logic.GoMove;
import com.hhsir.herewego.logic.markers.CircleMarker;
import com.hhsir.herewego.logic.markers.GoMarker;
import com.hhsir.herewego.logic.markers.SquareMarker;
import com.hhsir.herewego.logic.markers.TextMarker;
import com.hhsir.herewego.logic.markers.TriangleMarker;
...
public class SGFReader {
    ...
    private GoGame getGame() {
        try {
                    ...
                    switch (act_char) {
                        ...
                        case '(':
                            ...
                            if (!consuming_param) {
                                ...
                                Log.i(SGFReader.class,"   !!! opening variation" + game);
                                if (game != null) {
                        ...
                        case ')':
                            if (variationList.size() > 0) {
                                ...
                                Log.w(SGFReader.class,"popping variaton from stack");
                            } else {
                                Log.w(SGFReader.class,"variation vector underrun!!");
                            }
            ...
            Log.w(SGFReader.class,"Problem parsing SGF " + e);
        }
    ...
    private void processCommand() {
        ...
        if (act_cmd.equals("Black") || act_cmd.equals("B") || act_cmd.equals("W") || act_cmd.equals("White")) {
            ...
            Log.i(SGFReader.class,"Adding move " + act_cmd + " " + act_param + " at " + cell);
            if (act_param.length() == 0)
                ...
                if (b == GoGame.MOVE_VALID) {
                    ...
                    Log.w(SGFReader.class,"There was a problem in this game");
                }
            }
        ...
        if (act_cmd.equals("AddBlack") || act_cmd.equals("AB") || act_cmd.equals("AW") || act_cmd.equals("AddWhite")) {
            ...
            Log.i(SGFReader.class,"Adding stone " + act_cmd + " " + act_param + " at " + cell);
            ...
            if (act_param.length() != 0) {
                ...
                Log.w(SGFReader.class,"AB / AW command without param");
