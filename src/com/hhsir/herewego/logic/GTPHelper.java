...
public class GTPHelper {
    ...
    public static boolean doMoveByGTPString(String gtp_str, GoGame game) {
        ...
        Log.i(GTPHelper.class,"processing gtp str" + gtp_str);
        ...
        try {
            ...
            Log.w(GTPHelper.class,"Problem parsing coordinates from GTP " + e.toString());
        }

        // if we got here we could not make sense of the command
        Log.w(GTPHelper.class,"could not make sense of the GTP command: " + gtp_str);
        return false;
